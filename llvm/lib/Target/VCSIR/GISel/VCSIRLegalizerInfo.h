...
//===----------------------------------------------------------------------===//
/// \file
/// This file declares the targeting of the Machinelegalizer class for VCSIR.
/// \todo This should be generated by TableGen.
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_VCSIR_VCSIRMACHINELEGALIZER_H
#define LLVM_LIB_TARGET_VCSIR_VCSIRMACHINELEGALIZER_H
...
class VCSIRLegalizerInfo : public LegalizerInfo {
  const VCSIRSubtarget &STI;
  const unsigned XLen;
  const LLT sXLen;

public:
  VCSIRLegalizerInfo(const VCSIRSubtarget &ST);
