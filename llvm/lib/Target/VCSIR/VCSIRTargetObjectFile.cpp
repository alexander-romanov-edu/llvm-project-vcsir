//===-- VCSIRTargetObjectFile.cpp - VCSIR Object Info --------------------===//
//
...
#include "MCTargetDesc/VCSIRMCObjectFileInfo.h"
...
unsigned VCSIRELFTargetObjectFile::getTextSectionAlignment() const {
  return VCSIRMCObjectFileInfo::getTextSectionAlignment(
      *getContext().getSubtargetInfo());
}

void VCSIRELFTargetObjectFile::Initialize(MCContext &Ctx,
...
const MCExpr *VCSIRELFTargetObjectFile::getIndirectSymViaGOTPCRel(
...
bool VCSIRELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool VCSIRELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *VCSIRELFTargetObjectFile::SelectSectionForGlobal(
...
void VCSIRELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool VCSIRELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *VCSIRELFTargetObjectFile::getSectionForConstant(
