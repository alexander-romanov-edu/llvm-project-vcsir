//===-- VCSIRInstPrinter.h - Convert RISC-V MCInst to asm syntax --*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a VCSIR MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_VCSIR_MCTARGETDESC_VCSIRINSTPRINTER_H
#define LLVM_LIB_TARGET_VCSIR_MCTARGETDESC_VCSIRINSTPRINTER_H
...
class VCSIRInstPrinter : public MCInstPrinter {
public:
  VCSIRInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
